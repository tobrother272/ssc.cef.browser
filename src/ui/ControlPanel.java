    ...
    public ControlPanel(CefBrowser browser) {
        ...
        address_field_.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                //browser.executeJavaScript("window.cefQuery({request:'#1614686286284#jsvalue='+document.evaluate(\"//iframe[contains(@src,'/includes/commerce/authenticate')]\", document, null, 7, null).snapshotItem(0).getAttribute(\"src\")})", browser.getURL(), 0);
